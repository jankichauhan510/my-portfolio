const Contact = () => {
    return (
      <section id="contact" className="py-16 bg-gray-100 px-4 text-center">
        <h2 className="text-3xl font-bold mb-4">Contact Me</h2>
        <p className="text-gray-600 mb-6">I’d love to connect — feel free to reach out for opportunities or collaboration!</p>
